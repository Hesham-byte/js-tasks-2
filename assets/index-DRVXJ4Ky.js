...
var tasks = [
  ...
  },
  {
    ...
    task: function task10() {
      for (let i2 = 0; i2 < 5; i2++) {
        console.log("*".repeat(i2 + 1));
      }
    }
  },
  {
    ...
    task: function task11() {
      for (let i2 = 1; i2 <= 30; i2 += 3) {
        console.log(i2);
      }
    }
  },
